...
const randomWords = ["Happy New Year", "Chúc Mừng Năm Mới"];
const wordDotsMap = {};
randomWords.forEach((word) => {
	wordDotsMap[word] = MyMath.literalLattice(word, 3, "Gabriola,Amber", "90px");
});
...
const helpContent = {
	...
	scaleFactor: {
		header: "Zoom",
		body: "Moves you closer to or further away from the fireworks. For larger fireworks, you can choose a smaller zoom value, especially on a phone or tablet.",
	},
	wordShell: {
		header: "Text Fireworks",
		body: "After turning it on, words in the shape of fireworks will appear. For example: Happy New Year, May all your wishes come true, etc.",
	},
	autoLaunch: {
		header: "Automatic fireworks",
		body: "After turning it on, you can sit in front of your device screen and enjoy the fireworks. You can also turn it off, but after turning it off, you can only set off fireworks by clicking on the screen.",
	},
	finaleMode: {
		header: "Set off more fireworks at the same time",
		body: "You can automatically set off more fireworks at the same time (but you need to turn on Automatically set off fireworks first).",
	},
	hideControls: {
		header: "Hide Control Buttons",
		body: "Hide the buttons at the top of the screen. If you want to take a screenshot or need a seamless experience, you can hide the buttons, and you can still open the settings in the top right corner. ",
	},
	fullscreen: {
		header: "Full Screen",
	...
	longExposure: {
		header: "Keep the Spark of Fireworks",
		body: "Can preserve the sparks left by fireworks",
	},
};
...
function getWordDots(word) {
	...
	var res = MyMath.literalLattice(word, 3, "Gabriola,Amber", fontSize + "px");
